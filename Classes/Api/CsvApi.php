...
class CsvApi {
    ...
    * @param string $where_clause Additional WHERE clauses put in the end of the query. NOTICE: You must escape values in this argument with $GLOBALS['TYPO3_DB']->fullQuoteStr() yourself! DO NOT PUT IN GROUP BY, ORDER BY or LIMIT!
    ...
    */
    static public function exec_SELECTwriteRows (
        $filepath,
        $select_fields,
        $from_table,
        $where_clause,
